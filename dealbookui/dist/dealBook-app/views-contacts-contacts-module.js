...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/activities/activities.component.html":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/activities/activities.component.html ***!
  \***********************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"card mt-2\" *ngFor=\"let a of activityList\">\n    <div class=\"card-header\">\n        <div>{{a.activityType}}</div>\n        <div>{{a.date | datePipe | date:'mediumDate'}}</div>\n    </div>\n    <div class=\"card-body\">\n        <!-- <h5 class=\"card-title\">Special title treatment</h5> -->\n        <p class=\"card-text\">{{a.subject}}</p>\n        <!-- <a href=\"#\" class=\"btn btn-primary\">Go somewhere</a> -->\n    </div>\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/add-activity/add-activity.component.html":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/add-activity/add-activity.component.html ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<form #regForm='ngForm' (ngSubmit)=\"Register(regForm)\" class=\"activity-form\" style=\"height: 3em;\">\n    <div class=\"col-sm-12 row mt-2\" ngModelGroup=\"activity\" style=\"border: 1px;width: 99.5%;margin:0.5em -1em 0 0.2em;align-items: flex-start;padding:0.5em;background: #eef2f2;\">\n        <!-- <div class=\"col-12\" style=\"align-items: flex-start;\"> -->\n            <!-- <div class=\"row m-2 text-center\"> -->\n                <div class=\"col-sm-2 px-1\">\n                    <select style=\"font-size:13px;\" required class=\"form-control p-1\" placeholder=\"Activity Type\" name=\"activityType\"\n                        [(ngModel)]='activity.activityType'>\n                        <option value=\"\">Activity Type</option>\n                        <option value=\"1\">Call</option>\n                        <option value=\"2\">Email</option>\n                        <option value=\"3\">Meeting</option>\n                        <option value=\"4\">Text</option>\n                    </select>\n                </div>\n                <div class=\"col-sm-4 px-1\" style=\"line-height: 2.5em;\">\n                    <div class=\"form-inline\" ngModelGroup=\"fallowup\">\n                        <div class=\"form-check\">\n                            <label style=\"font-size:13px;\" class=\"form-check-label\" name=\"Follow Up\">\n                                <input style=\"font-size:13px;\" class=\"form-check-input\" #active [(ngModel)]='activity.isFollowup'\n                                    name=\"isFollowup\" [checked]='activity.isFollowup' type=\"checkbox\" (change)=\"isFollowupDate(activity.fallowup)\">Follow Up\n                            </label>\n                        </div>\n                        <div>\n                            <input type=\"text\" class=\"form-control p-1\" name=\"fallowUpDate\" style=\"font-size:13px;\" placeholder=\"Datepicker\" [(ngModel)]='activity.fallowup' bsDatepicker [bsConfig]=\"{dateInputFormat: 'MM/DD/YYYY',showWeekNumbers:false}\" [daysDisabled]=\"[6,0]\" *ngIf=\"activity.isFollowup\"/>\n                        </div>\n                    </div>\n                </div>\n            <!-- </div>\n            <div class=\"row mx-2\"> -->\n                <div class=\"col-sm-4 px-1\" style=\"display:flex; flex-direction: row; justify-content: center;\">\n                    <div style=\"width:20%;line-height: 2.5em;\">\n                        <label style=\"font-size:13px;\" for=\"message\" name=\"Comment\" >Comment</label>\n                    </div>\n                    <div style=\"width: 80%;max-height: 2em;margin-left: 1em;min-width: -webkit-fill-available;\">\n                    <textarea style=\"height: 2.3em;font-size:13px;\" class=\"form-control\" required id=\"message\" name=\"body\" rows=\"2\" name=\"subject\"\n                        [(ngModel)]='activity.subject' placeholder=\"Subject\" ></textarea>\n                    </div>\n                </div>\n                <!-- <div class=\"col-sm-4 px-1\" style=\"display:flex; flex-direction: row; justify-content: center; align-items: center\">\n                    <label for=\"message\" name=\"Comment\" >Comment</label>\n                    <textarea style=\"margin-left: 1em;\" class=\"form-control\" required id=\"message\" name=\"body\" rows=\"2\" name=\"subject\"\n                        [(ngModel)]='activity.note' placeholder=\"Note\" ></textarea>\n                    \n                </div> -->\n                <div class=\"col-sm-2 text-center pt-1\">\n                    <!-- <ng-container *ngIf=\"type == 'Edit'\"> -->\n                        <span style=\"font-size:15px;width:50%\"  *ngIf=\"type == 'Edit'\">\n                            <i style=\"font-size: 25px;\n                             margin: 0px;\n                            padding: 0px;\"  class=\"fa fa-check-circle text-primary mr-1\"\n                            *ngIf=\"activity.activityType != '' && activity.subject != '' && isFollow(active.isFollowup, activity.fallowup)\"\n                            (click)=\"activityUpdate(activity, index)\" aria-hidden=\"true\"></i>\n                        <i style=\"font-size:15px;\"\n                            class=\"fa fa-times-circle\" style=\"font-size: 25px;\n                            float: right;\n                            margin: 0px;\n                            padding: 0px;\" (click)=\"activityRemove(activity,index)\"\n                            aria-hidden=\"true\"></i> </span>\n                    <!-- <span class=\"activity-btns\" style=\"font-size: 1.5em;\">\n                    </span> -->\n                    <!-- </ng-container> -->\n                    <!-- <ng-container *ngIf=\"type == 'Add'\"> -->\n                        <span style=\"font-size:15px;width:50%\" *ngIf=\"type == 'Add'\"><i class=\"fa fa-check-circle text-primary mr-1\" style=\"font-size: 25px;\n                            margin: 0px;\n                            padding: 0px;\"\n                        \n                            *ngIf=\"activity.activityType != '' && activity.subject != '' && isFollow(active.isFollowup, activity.fallowup)\"\n                            (click)=\"activitySubmit(activity, index)\" aria-hidden=\"true\"></i>\n                        <i\n                            class=\"fa fa-times-circle\" style=\"font-size: 25px;\n                            float: right;\n                            margin: 0px;\n                            padding: 0px;\" (click)=\"activityRemove(activity,index)\"\n                            aria-hidden=\"true\"></i></span>\n                    <!-- <span class=\"activity-btns\" style=\"font-size: 1.5em;\">\n                        </span> -->\n                    <!-- </ng-container> -->\n                </div>\n            <!-- </div> --> \n        <!-- </div> -->\n\n    </div>\n</form>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/add-contact/add-contact.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/add-contact/add-contact.component.html ***!
  \*************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n\n<div class=\"row-container\" (click)=\"showDetails(contact.id,contact)\" [class.active]=\"selectedIndex == contact.id\" [class.highlight]=\"curHierarchy\" [class.selected]=\"selected\">\n    <ng-container *ngFor=\"let col of model | async; let i = index;\">\n        <div class=\"columns\" *ngIf=\"col.display\" [ngClass]=\"'column-'+i+' '+col.title\">\n            <!-- {{col.title!='contactowner' && col.title!='reportto'?contact && contact[col.title]:contact && contact[col.title]?contact && contact[col.title].name:\"\"}} -->\n            {{date.indexOf(col.title) > -1 ? renderDate(contact[col.title], col.title) : renderValue(contact[col.title])}}\n        </div>\n    </ng-container>\n    <div class=\"column-last\"><span>\n        <i title=\"Hierarchy\" (click)=\"hierarchyPanel(contact, $event);$event.stopPropagation();\" class=\"fa fa-sitemap mr-1\" aria-hidden=\"true\"></i> \n        <i title=\"notification(s)\" (click)=\"addNote(contact, $event)\" class=\"fa fa-sticky-note-o mr-1\" aria-hidden=\"true\"></i>\n        <i title=\"Delete Contact\" (click)=\"deleteContact(contact, $event.target.value);$event.stopPropagation();\" class=\"fa fa-trash mr-1\" style=\"color:#f00;\" aria-hidden=\"true\" ></i>\n    </span></div>\n</div>\n\n<app-contact-view *ngIf=\"selectedIndex == contact.id \" [contact]=\"contact\"   (addActivity)=\"addActivity($event)\"></app-contact-view>\n\n<!-- [isMinimize]=\"0\" -->");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/contact-view/contact-view.component.html":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/contact-view/contact-view.component.html ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/edit-activity/edit-activity.component.html":
/*!*****************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/edit-activity/edit-activity.component.html ***!
  \*****************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/edit-contcat/edit-contcat.component.html":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/edit-contcat/edit-contcat.component.html ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./src/app/common/customepipes/date.pipe.ts":
/*!**************************************************!*\
  !*** ./src/app/common/customepipes/date.pipe.ts ***!
  \**************************************************/
...
/***/ "./src/app/views/contacts/activities/activities.component.scss":
/*!*********************************************************************!*\
  !*** ./src/app/views/contacts/activities/activities.component.scss ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3ZpZXdzL2NvbnRhY3RzL2FjdGl2aXRpZXMvYWN0aXZpdGllcy5jb21wb25lbnQuc2NzcyJ9 */");

/***/ }),

/***/ "./src/app/views/contacts/activities/activities.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/views/contacts/activities/activities.component.ts ***!
  \*******************************************************************/
...
let ActivitiesComponent = class ActivitiesComponent {
    ...
    activites() {
        this.activityList = this.contactService.contacts.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(o => [].concat(...(o.filter(c => c.activities.length > 0)).map(a => a.activities))));
    }
};
...
ActivitiesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./activities.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/activities/activities.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./activities.component.scss */ "./src/app/views/contacts/activities/activities.component.scss")).default]
    })
], ActivitiesComponent);
...
/***/ "./src/app/views/contacts/add-activity/add-activity.component.scss":
/*!*************************************************************************!*\
  !*** ./src/app/views/contacts/add-activity/add-activity.component.scss ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".add-activity {\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  right: 15px;\n  top: 3px;\n  z-index: 9999;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/views/contacts/add-activity/add-activity.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/views/contacts/add-activity/add-activity.component.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_contacts_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/contacts.service */ "./src/app/services/contacts.service.ts");
/* harmony import */ var src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/providers/fetchserverdata */ "./src/app/providers/fetchserverdata.ts");
...
let AddActivityComponent = class AddActivityComponent {
    constructor(toastr, utils, serviceCallProvider, contactServicce) {
        this.toastr = toastr;
        this.utils = utils;
        this.serviceCallProvider = serviceCallProvider;
        this.contactServicce = contactServicce;
        this.submitActivity = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.removeActivity = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.addedActivity = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    isFollow(isChecked, isDate) {
        if (!isChecked || (isChecked && isDate.length > 0))
            return true;
        return false;
    }
};
AddActivityComponent.ctorParameters = () => [
    ...
    { type: src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_3__["FetchServerDataProvider"] },
    { type: src_app_services_contacts_service__WEBPACK_IMPORTED_MODULE_2__["ContactsService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('addActivity')
], AddActivityComponent.prototype, "activity", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('contact')
], AddActivityComponent.prototype, "contact", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('index')
], AddActivityComponent.prototype, "index", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('type')
], AddActivityComponent.prototype, "type", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('submitActivity')
], AddActivityComponent.prototype, "submitActivity", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('removeActivity')
], AddActivityComponent.prototype, "removeActivity", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('addedActivity')
], AddActivityComponent.prototype, "addedActivity", void 0);
AddActivityComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-activity',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-activity.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/add-activity/add-activity.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-activity.component.scss */ "./src/app/views/contacts/add-activity/add-activity.component.scss")).default]
    })
...
/***/ "./src/app/views/contacts/add-contact/add-contact.component.css":
/*!**********************************************************************!*\
  !*** ./src/app/views/contacts/add-contact/add-contact.component.css ***!
  \**********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ul {\n    list-style: none;\n    padding: 5px;\n    background: #fff;\n    font-size: 1rem;\n    z-index: 999;\n}\n\nli {\n    margin: 4px 1px;\n    cursor: pointer;\n}\n\nhr {\n    display: block;\n    height: 1px;\n    border: 0;\n    border-top: 1px solid #ccc;\n    margin: 1em 0;\n    padding: 0;\n}\n\nli:hover {\n    color: #00c6c6;\n}\n\n.form-group {\n    position: relative;\n    margin-right: 0.5rem;\n    flex: 1;\n}\n\n.form-control{\n    font-size:13px;\n}\n\n.form-group label:not(.isuser) {\n    /* position: absolute;\n    top: -20px;\n    left: 0; */\n    color: #070707;\n    display: block;\n    width: 100%\n    /* color: #00c6c6; */\n    /* font-weight: bold; */\n    /* transition: top 0.2s ease-out, left 0.2s ease-in; */\n}\n\n.form-group input:not([type='checkbox']),\n.form-group select {\n    padding-left: 5px;\n    width: 85%;\n}\n\n.form-inline {\n    width: 100%;\n    padding-bottom: 6px;\n}\n\n/* .form-group input:focus+label,\n.form-group select:focus+label,\n.form-group label.hasValue {\n    top: -20px;\n    left: 0;\n    color: #00c6c6;\n    font-weight: bold;\n    animation: shake 0.5s;\n} */\n\ni {\n    display: inline-block;\n    border: 1px solid #ccc;\n    width: 25px;\n    height: 25px;\n    line-height: 25px;\n    border-radius: 50%;\n    margin: 0;\n    text-align: center;\n    background: #fff;\n    color: #00c5c5;\n}\n\n.fa {\n    cursor: pointer;\n}\n\n.contactowner {\n    position: relative;\n}\n\n.contactowner>ul {\n    position: absolute;\n    top: 31px;\n    left: 0;\n    display: none;\n    box-shadow: 0px 1px 2px #333;\n    width: 163px;\n}\n\n.contactowner>ul:hover,\n.contactowner>input:focus~ul {\n    display: block!important;\n}\n\n.custom-file-input {\n    width: auto;\n}\n\n.reporttolist {\n    position: absolute;\n    top: 50px;\n    max-height: 250px;\n    overflow: auto;\n    z-index: 99;\n    border: 1px solid #ccc;\n    min-width: 100%;\n}\n\n.reporttolist ul {\n    margin: 0;\n    padding: 0 2px;\n}\n\n.reporttolist li {\n    white-space: nowrap;\n}\n\n.custom-file-label {\n    right: auto;\n    width: 250px;\n}\n\n.no-flex {\n    flex: none;\n}\n\n.box {\n    box-shadow: inset 0px 0px 7px 3px #ccc;\n    padding: 0.8em 0;\n}\n\n.edit h4 {\n    font-size: 1rem;\n}\n\n.card-header{\n\nheight: 3em;\nbackground: #037777;\ncolor: #fff;\n}\n\n@keyframes shake {\n    0% {\n        transform: translate(1px, 1px) rotate(0deg);\n    }\n    10% {\n        transform: translate(-1px, -2px) rotate(-1deg);\n    }\n    20% {\n        transform: translate(-3px, 0px) rotate(1deg);\n    }\n    30% {\n        transform: translate(3px, 2px) rotate(0deg);\n    }\n    40% {\n        transform: translate(1px, -1px) rotate(1deg);\n    }\n    50% {\n        transform: translate(-1px, 2px) rotate(-1deg);\n    }\n    60% {\n        transform: translate(-3px, 1px) rotate(0deg);\n    }\n    70% {\n        transform: translate(3px, 1px) rotate(-1deg);\n    }\n    80% {\n        transform: translate(-1px, -1px) rotate(1deg);\n    }\n    90% {\n        transform: translate(1px, 2px) rotate(0deg);\n    }\n    100% {\n        transform: translate(1px, -2px) rotate(-1deg);\n    }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/views/contacts/add-contact/add-contact.component.ts":
/*!*********************************************************************!*\
  !*** ./src/app/views/contacts/add-contact/add-contact.component.ts ***!
  \*********************************************************************/
...
/* harmony import */ var src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/providers/fetchserverdata */ "./src/app/providers/fetchserverdata.ts");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js");
/* harmony import */ var _contacts_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../contacts.component */ "./src/app/views/contacts/contacts.component.ts");
/* harmony import */ var _providers_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../providers/utils */ "./src/app/providers/utils.ts");
...
let AddContactComponent = class AddContactComponent {
    constructor(ContactsComponent, http, toastr, serviceCallProvider, utils, _formBuilder, contactService, emService) {
        ...
        this.closeAddContact = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    set contact(contact) {
        if (this.title == 'Edit Contact' && contact) {
            this.editObject = Object.assign({}, contact);
    ...
    createContact() {
        ...
        return this._formBuilder.group({
            salutation: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.salutation),
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.name),
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(re)]),
            phone: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.mobile, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]),
            company: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.contactOrg),
            designation: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.designation),
            line: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.address.line),
            country: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.address.country),
            state: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.address.state),
            city: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.address.city),
            zipCode: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.address.zipCode),
            isuser: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.isuser),
            role: this._formBuilder.group({
                id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.role || ""),
                name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("")
            }),
            contacttype: this._formBuilder.group({
                id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.contacttype || ""),
                name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("")
            }),
            reportto: this._formBuilder.group({
                id: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](""),
                name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.contactObj.reportto || "")
            }),
    ...
    get contactsList() {
        return this.contactForm.get('newContacts');
    }
    ...
    onSubmit() {
        ...
        if (this.title == 'Edit Contact') {
            list = [Object.assign({}, this.editObject, list[0])];
    ...
    pushFileToStorage(file) {
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpRequest"]('POST', this.serverUrl + serviceURL, formdata, {
            reportProgress: true,
            responseType: 'text'
        });
    ...
    validateData(jsonData) {
        ...
        if (notfound.length > 0) {
            ...
            let keys = ['email'];
            let filtered = mergeArray.filter((s => o => (k => !s.has(k) && s.add(k))(keys.map(k => o[k]).join('|')))(new Set));
...
AddContactComponent.ctorParameters = () => [
    { type: _contacts_component__WEBPACK_IMPORTED_MODULE_7__["ContactsComponent"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClient"] },
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] },
    { type: src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__["FetchServerDataProvider"] },
    { type: _providers_utils__WEBPACK_IMPORTED_MODULE_8__["Utils"] },
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('closeAddContact')
], AddContactComponent.prototype, "closeAddContact", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('createType')
], AddContactComponent.prototype, "createType", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], AddContactComponent.prototype, "title", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])("contact")
], AddContactComponent.prototype, "contact", null);
AddContactComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-contact',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./add-contact.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/add-contact/add-contact.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./add-contact.component.css */ "./src/app/views/contacts/add-contact/add-contact.component.css")).default]
    })
], AddContactComponent);
...
/***/ "./src/app/views/contacts/contact-card/contact-card.component.css":
/*!************************************************************************!*\
  !*** ./src/app/views/contacts/contact-card/contact-card.component.css ***!
  \************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".rows {\n    border-bottom: 1px solid #ececec;\n    padding: 5px;\n}\n\n.row-container {\n    position: relative;\n    display: flex;\n}\n\nspan {\n    color: #00c6c6;\n}\n\n.head {\n    font-weight: bold;\n    text-transform: capitalize;\n}\n\n.columns {\n    /* width: calc((100% - 45px)/7); */\n    word-break: break-word;\n    padding: 5px 2px;\n    display: inline-block;\n    cursor: pointer;\n    -webkit-user-select: none;\n       -moz-user-select: none;\n            user-select: none;\n    font-size: 14px;\n    flex: 1;\n    text-indent: 5px;\n}\n\n.columns span:hover {\n    color: #00c6c6;\n    font-weight: bold;\n}\n\n.name,\n.company,\n.contactowner {\n    text-transform: capitalize;\n}\n\n.row-container.highlight {\n    background: #bfbfbf;\n    color: #000;\n    font-weight: bold;\n}\n\n.row-container.active {\n    background: #d9d9d9\n}\n\n.highlight span {\n    color: #fff;\n}\n\n.selected {\n    background: #037777!important;\n    color: #fff!important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/views/contacts/contact-card/contact-card.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/views/contacts/contact-card/contact-card.component.ts ***!
  \***********************************************************************/
...
/* harmony import */ var _views_contacts_hierarchy_hierarchy_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../views/contacts/hierarchy/hierarchy.component */ "./src/app/views/contacts/hierarchy/hierarchy.component.ts");
...
/* harmony import */ var src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/providers/fetchserverdata */ "./src/app/providers/fetchserverdata.ts");
/* harmony import */ var _providers_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../providers/utils */ "./src/app/providers/utils.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm2015/ngx-toastr.js");
/* harmony import */ var _contacts_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../contacts.component */ "./src/app/views/contacts/contacts.component.ts");
/* harmony import */ var _common_sidewindow_sidewindow_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../common/sidewindow/sidewindow.component */ "./src/app/common/sidewindow/sidewindow.component.ts");
/* harmony import */ var _hierarchy_modal_hierarchy_modal_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../hierarchy-modal/hierarchy-modal.component */ "./src/app/hierarchy-modal/hierarchy-modal.component.ts");
...
let ContactCardComponent = class ContactCardComponent {
    constructor(sidewindowcomponent, contactsComponent, hierarchyModalComponent, toastr, utils, serviceCallProvider, datePipe, emService, contactService) {
        this.sidewindowcomponent = sidewindowcomponent;
        this.contactsComponent = contactsComponent;
        this.hierarchyModalComponent = hierarchyModalComponent;
        this.toastr = toastr;
        this.utils = utils;
        this.serviceCallProvider = serviceCallProvider;
        ...
        this.emService = emService;
        this.contactService = contactService;
        this.openWindow = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.selectedRow = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.scrollToTop = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.selectedIndex = null;
        this.curHierarchy = false;
        this.date = ["createdOn", "updatedOn", "date", "fallowUp"];
        this.selected = false;
    }
    set isTrue(val) {
    }
    ;
    set selectedHierarchy(v) {
        this.curHierarchy = false;
        if (v == this.index) {
    ...
    hierarchyPanel(contact, $event) {
        ...
        this.emService.showHideWindow(true, _views_contacts_hierarchy_hierarchy_component__WEBPACK_IMPORTED_MODULE_3__["HierarchyComponent"], `${contact.name} - Hierarchy`);
        //$event.stopPropagation();
    }
    updateChart(contact) {
...
ContactCardComponent.ctorParameters = () => [
    { type: _common_sidewindow_sidewindow_component__WEBPACK_IMPORTED_MODULE_10__["SidewindowComponent"] },
    { type: _contacts_component__WEBPACK_IMPORTED_MODULE_9__["ContactsComponent"] },
    { type: _hierarchy_modal_hierarchy_modal_component__WEBPACK_IMPORTED_MODULE_11__["HierarchyModalComponent"] },
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_8__["ToastrService"] },
    { type: _providers_utils__WEBPACK_IMPORTED_MODULE_6__["Utils"] },
    { type: src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__["FetchServerDataProvider"] },
...
], ContactCardComponent.prototype, "openWindow", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ContactCardComponent.prototype, "selectedRow", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ContactCardComponent.prototype, "scrollToTop", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactCardComponent.prototype, "index", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactCardComponent.prototype, "isFirst", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactCardComponent.prototype, "isTrue", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactCardComponent.prototype, "contacts", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactCardComponent.prototype, "contact", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ContactCardComponent.prototype, "selectedHierarchy", null);
ContactCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-contact-card',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./contact-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/contact-card/contact-card.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./contact-card.component.css */ "./src/app/views/contacts/contact-card/contact-card.component.css")).default]
    })
...
/***/ "./src/app/views/contacts/contact-view/contact-view.component.scss":
/*!*************************************************************************!*\
  !*** ./src/app/views/contacts/contact-view/contact-view.component.scss ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".container-fluid {\n  border-top: 1px solid #ececec;\n  padding: 10px;\n  background-color: #fff;\n  border-radius: 8px;\n  border-bottom: 1px solid #00c6c6;\n}\n\n.tag {\n  display: inline-block;\n  padding: 0 5px;\n  font-size: 14px;\n}\n\n.tab-content {\n  margin-top: -1px;\n  background: #fff;\n  border: 1px solid #fff;\n}\n\nh4,\n.nav-tabs .nav-link.active {\n  color: #00c6c6;\n}\n\n.nav-tabs .nav-link {\n  font-size: 15px;\n}\n\n.btn.focus,\n.btn:focus {\n  box-shadow: none;\n}\n\n.submenu {\n  position: absolute;\n  font-size: 14px;\n  color: #000;\n  width: 80px;\n  border: 1px solid #ccc;\n  z-index: 4;\n  background: #fff;\n  padding: 5px 10px;\n  top: 35px;\n  right: 15px;\n  line-height: 21px;\n  border-radius: 10px;\n}\n\n.form-inline {\n  height: 100%;\n}\n\n.submenu > div {\n  cursor: pointer;\n  margin: 0px 0 1px;\n  padding: 2px 5px;\n}\n\n.submenu > div:hover {\n  background: #e0e0e0;\n}\n\n.submenu:after {\n  content: \"\";\n  width: 1px;\n  height: 1px;\n  border-left: 10px solid #f000;\n  border-right: 10px solid #f000;\n  position: absolute;\n  top: -6px;\n  right: 24%;\n  border-bottom: 5px solid #ccc;\n}\n\nspan.btns {\n  font-size: 13px;\n  display: inline-block;\n  text-align: center;\n  margin: 0 5px;\n  min-width: 40px;\n  cursor: pointer;\n  color: #000;\n}\n\nh4 span i,\n.pull-right i {\n  display: inline-block;\n  border: 1px solid #ccc;\n  width: 25px;\n  height: 25px;\n  line-height: 25px;\n  border-radius: 50%;\n  margin: 0 2px;\n}\n\n.profile + div,\nform {\n  clear: both;\n}\n\n.add-activity {\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  right: 15px;\n  top: 7px;\n  z-index: 9999;\n}\n\n.add-activity i,\n.activity-btns i {\n  display: inline-block;\n  border: 1px solid #ccc;\n  width: 25px;\n  height: 25px;\n  line-height: 25px;\n  border-radius: 50%;\n  margin: 0;\n}\n\ni {\n  text-align: center;\n  cursor: pointer;\n}\n\nspan.btns {\n  font-size: 13px;\n  display: inline-block;\n  text-align: center;\n  margin: -4px 4px;\n  min-width: 40px;\n  cursor: pointer;\n  color: #000;\n}\n\n.table td,\n.table th {\n  padding: 4px 60px 4px 4px;\n  position: relative;\n}\n\n.table td > .btns-right {\n  position: absolute;\n  right: 0;\n  top: 1px;\n}\n\n.activity-form span i {\n  margin: 2px;\n  font-size: 1rem;\n  line-height: 22px;\n}\n\n/*   For Form */\n\n.container-fluid > p {\n  background: #037777;\n  color: #fff;\n  cursor: move;\n  font-weight: bold;\n}\n\n.container-fluid {\n  position: relative;\n  padding: 0;\n}\n\n.closebtn {\n  position: absolute;\n  right: 10px;\n  top: 5px;\n  color: #fff;\n  font-size: 1.1rem;\n  cursor: pointer;\n}\n\n.btn {\n  padding: 0 0.6em;\n}\n\nhr {\n  margin: 0 0 10px;\n}\n\np {\n  margin: 0;\n}\n\n.profile {\n  padding: 10px 5px 10px;\n  border-bottom: 1px solid #dee2e6;\n}\n\n.submenu {\n  display: none;\n}\n\n.openactivities:hover + .submenu,\n.submenu:hover {\n  display: block;\n}\n\n.disabled {\n  opacity: 0.6;\n  cursor: not-allowed;\n}\n\n.add-activity[_ngcontent-msw-c134] {\n  position: absolute;\n  width: 30px;\n  height: 30px;\n  right: 15px;\n  top: 3px;\n  z-index: 9999;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/views/contacts/contact-view/contact-view.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/views/contacts/contact-view/contact-view.component.ts ***!
  \***********************************************************************/
...
/* harmony import */ var src_app_services_contacts_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/contacts.service */ "./src/app/services/contacts.service.ts");
/* harmony import */ var _services_event_emitter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/event-emitter.service */ "./src/app/services/event-emitter.service.ts");
/* harmony import */ var src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/providers/fetchserverdata */ "./src/app/providers/fetchserverdata.ts");
...
let ContactViewComponent = class ContactViewComponent {
    constructor(toastr, utils, serviceCallProvider, contactsService, emService) {
        this.toastr = toastr;
        this.utils = utils;
        this.serviceCallProvider = serviceCallProvider;
        this.contactsService = contactsService;
        this.emService = emService;
        this.addActivity = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.activeTab = 'activies';
    ...
    deleteActivity(index, id) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
            ...
            if (result.value) {
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire('Deleted!', 'Your Activity has been deleted.', 'success');
            }
        });
    }
    editActivity(index) {
...
ContactViewComponent.ctorParameters = () => [
    { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] },
    { type: _providers_utils__WEBPACK_IMPORTED_MODULE_5__["Utils"] },
    { type: src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_4__["FetchServerDataProvider"] },
    { type: src_app_services_contacts_service__WEBPACK_IMPORTED_MODULE_2__["ContactsService"] },
    { type: _services_event_emitter_service__WEBPACK_IMPORTED_MODULE_3__["EventEmitterService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ContactViewComponent.prototype, "addActivity", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('contact')
...
ContactViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./contact-view.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/contact-view/contact-view.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./contact-view.component.scss */ "./src/app/views/contacts/contact-view/contact-view.component.scss")).default]
    })
...
/* harmony import */ var _contacts_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contacts.component */ "./src/app/views/contacts/contacts.component.ts");
...
/***/ "./src/app/views/contacts/contacts.component.css":
/*!*******************************************************!*\
  !*** ./src/app/views/contacts/contacts.component.css ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".row {\n    display: flex;\n    flex-wrap: wrap;\n    margin-right: -28px;\n    margin-left: -2px;\n    height: 3em;\n    background-color: #fff;\n    /* box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); */\n}\n\n\n\n.rows:not(.head):nth-child(even),\n.rows:not(.head):hover {\n    background-color: #f9f9f9;\n\n}\n\n\n\n/* .rows:not(.head):hover {\n    background-color: #f9f9f9;\n    text-decoration: none;\n    font-weight: bold;\n} */\n\n\n\n.top-menu-heading {\n    display: inline-block;\n    padding: 5px;\n    /* border: 1px solid #ccc; */\n    border-radius: 5px;\n    font-size: 0.9rem;\n    cursor: pointer;\n}\n\n\n\n.h5 {\n    margin: 0;\n    padding: 0;\n}\n\n\n\n.has-search .form-control-feedback {\n    position: absolute;\n    z-index: 2;\n    display: block;\n    width: 2.375rem;\n    height: 1.9rem;\n    line-height: 1.9rem;\n    text-align: center;\n    pointer-events: none;\n    color: #aaa;\n}\n\n\n\n.has-search .form-control {\n    padding-left: 2.375rem;\n}\n\n\n\n.form-control {\n    border: 0 solid transparent;\n    /* border-bottom: 1px solid #d3efef; */\n    /* border-radius: 0; */\n}\n\n\n\n.has-search {\n    position: relative;\n    margin-right: 25px;\n}\n\n\n\n.column-settings {\n    position: absolute;\n    right: 20px;\n    font-size: 1rem;\n    cursor: pointer;\n}\n\n\n\n.columns:not(.active) .sort-icon {\n    color: #426e6e;\n}\n\n\n\nsection {\n    overflow: auto;\n    height: calc(100vh - 160px);\n    width: calc(100% + 12px);\n}\n\n\n\n.form-inline {\n    justify-content: flex-end;\n}\n\n\n\n.count {\n    font-weight: bold;\n}\n\n\n\n.rows:not(.head):nth-child(even),\n.rows:not(.head):hover {\n    background-color: #f9f9f9;\n}\n\n\n\n.top-menu-heading {\n    display: inline-block;\n    padding: 5px;\n    /* border: 1px solid #ccc; */\n    border-radius: 5px;\n    font-size: 0.9rem;\n    cursor: pointer;\n}\n\n\n\n.h5 {\n    margin: 0;\n    padding: 0;\n}\n\n\n\n.has-search .form-control-feedback {\n    position: absolute;\n    z-index: 2;\n    display: block;\n    width: 2.375rem;\n    height: 1.9rem;\n    line-height: 1.9rem;\n    text-align: center;\n    pointer-events: none;\n    color: #aaa;\n}\n\n\n\n.has-search .form-control {\n    padding-left: 2.375rem;\n}\n\n\n\n.form-control {\n    border: 0 solid transparent;\n    /* border-bottom: 1px solid #d3efef; */\n    /* border-radius: 0; */\n}\n\n\n\n.has-search {\n    position: relative;\n    margin-right: 25px;\n}\n\n\n\n.column-settings {\n    position: absolute;\n    right: 20px;\n    font-size: 1rem;\n    cursor: pointer;\n}\n\n\n\n.columns:not(.active) .sort-icon {\n    color: #b5b5b5;\n}\n\n\n\nsection {\n    overflow: auto;\n    height: calc(100vh - 160px);\n    width: calc(100% + 12px);\n}\n\n\n\n.form-inline {\n    justify-content: flex-end;\n}\n\n\n\n.count {\n    font-weight: bold;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../providers/fetchserverdata */ "./src/app/providers/fetchserverdata.ts");
/* harmony import */ var _providers_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../providers/utils */ "./src/app/providers/utils.ts");
/* harmony import */ var src_app_common_column_list_column_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/common/column-list/column-list.component */ "./src/app/common/column-list/column-list.component.ts");
...
let ContactsComponent = class ContactsComponent {
    constructor(http, toastr, datePipe, serviceCallProvider, utils, contactsService, r, renderer, emService) {
        this.http = http;
        this.toastr = toastr;
        this.datePipe = datePipe;
        this.serviceCallProvider = serviceCallProvider;
        ...
        this.isOpenColumnSetting = false;
        this.panelcategory = "";
        this.totalCount = 0;
        this.contactcardarray = [];
        this.contactList = [];
        this.CONTACTS_TABLE_COLUMNS = [
    ...
    deleteContacts(id) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_12___default.a.fire({
            ...
            if (result.value) {
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_12___default.a.fire('Deleted!', 'Your contact has been deleted.', 'success');
            }
        });
    }
    ngOnDestroy() {
    ...
    sortContacts(columnname, isAssending, datatype) {
    ...
    showPanel() {
        ...
        this.emService.showHideWindow(this.isOpenColumnSetting, src_app_common_column_list_column_list_component__WEBPACK_IMPORTED_MODULE_7__["ColumnListComponent"], "Contacts Columns Settings");
    }
...
ContactsComponent.ctorParameters = () => [
    ...
    { type: _providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__["FetchServerDataProvider"] },
    { type: _providers_utils__WEBPACK_IMPORTED_MODULE_6__["Utils"] },
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_11__["CdkVirtualScrollViewport"], { static: false })
], ContactsComponent.prototype, "viewPort", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:resize', ['$event'])
], ContactsComponent.prototype, "onResize", null);
ContactsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-contacts',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./contacts.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/contacts.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./contacts.component.css */ "./src/app/views/contacts/contacts.component.css")).default]
    })
], ContactsComponent);
...
/* harmony import */ var _contacts_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./contacts-routing.module */ "./src/app/views/contacts/contacts-routing.module.ts");
/* harmony import */ var _contacts_contacts_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../contacts/contacts.component */ "./src/app/views/contacts/contacts.component.ts");
/* harmony import */ var _filter_contacts_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filter-contacts.pipe */ "./src/app/views/contacts/filter-contacts.pipe.ts");
/* harmony import */ var _add_contact_add_contact_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./add-contact/add-contact.component */ "./src/app/views/contacts/add-contact/add-contact.component.ts");
/* harmony import */ var _common_customepipes_date_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/customepipes/date.pipe */ "./src/app/common/customepipes/date.pipe.ts");
...
/* harmony import */ var _contact_view_contact_view_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./contact-view/contact-view.component */ "./src/app/views/contacts/contact-view/contact-view.component.ts");
/* harmony import */ var _contact_card_contact_card_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./contact-card/contact-card.component */ "./src/app/views/contacts/contact-card/contact-card.component.ts");
/* harmony import */ var _activities_activities_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./activities/activities.component */ "./src/app/views/contacts/activities/activities.component.ts");
/* harmony import */ var _add_activity_add_activity_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./add-activity/add-activity.component */ "./src/app/views/contacts/add-activity/add-activity.component.ts");
/* harmony import */ var _text_search_filter_pipe__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./text-search-filter.pipe */ "./src/app/views/contacts/text-search-filter.pipe.ts");
/* harmony import */ var _edit_contcat_edit_contcat_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./edit-contcat/edit-contcat.component */ "./src/app/views/contacts/edit-contcat/edit-contcat.component.ts");
/* harmony import */ var _edit_activity_edit_activity_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./edit-activity/edit-activity.component */ "./src/app/views/contacts/edit-activity/edit-activity.component.ts");
...
ContactsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _common_customepipes_date_pipe__WEBPACK_IMPORTED_MODULE_8__["DatePipe"],
            _filter_contacts_pipe__WEBPACK_IMPORTED_MODULE_6__["FilterContactsPipe"],
            ...
            _contact_card_contact_card_component__WEBPACK_IMPORTED_MODULE_12__["ContactCardComponent"],
            _activities_activities_component__WEBPACK_IMPORTED_MODULE_13__["ActivitiesComponent"],
            _add_activity_add_activity_component__WEBPACK_IMPORTED_MODULE_14__["AddActivityComponent"],
            _text_search_filter_pipe__WEBPACK_IMPORTED_MODULE_15__["TextSearchFilterPipe"],
            _edit_contcat_edit_contcat_component__WEBPACK_IMPORTED_MODULE_16__["EditContcatComponent"],
            _edit_activity_edit_activity_component__WEBPACK_IMPORTED_MODULE_17__["EditActivityComponent"],
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _contacts_routing_module__WEBPACK_IMPORTED_MODULE_4__["ContactsRoutingModule"],
...
/***/ "./src/app/views/contacts/edit-activity/edit-activity.component.scss":
/*!***************************************************************************!*\
  !*** ./src/app/views/contacts/edit-activity/edit-activity.component.scss ***!
  \***************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3ZpZXdzL2NvbnRhY3RzL2VkaXQtYWN0aXZpdHkvZWRpdC1hY3Rpdml0eS5jb21wb25lbnQuc2NzcyJ9 */");

/***/ }),

/***/ "./src/app/views/contacts/edit-activity/edit-activity.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/views/contacts/edit-activity/edit-activity.component.ts ***!
  \*************************************************************************/
...
EditActivityComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-activity.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/edit-activity/edit-activity.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-activity.component.scss */ "./src/app/views/contacts/edit-activity/edit-activity.component.scss")).default]
    })
...
/***/ "./src/app/views/contacts/edit-contcat/edit-contcat.component.scss":
/*!*************************************************************************!*\
  !*** ./src/app/views/contacts/edit-contcat/edit-contcat.component.scss ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ul {\n  list-style: none;\n  padding: 5px;\n  background: #fff;\n  font-size: 1rem;\n  z-index: 999;\n}\n\nli {\n  margin: 4px 1px;\n  cursor: pointer;\n}\n\nli:hover {\n  color: #00c6c6;\n}\n\n.form-group {\n  position: relative;\n  margin-right: 0.5rem;\n  flex: 1;\n}\n\n.form-control {\n  font-size: 13px;\n}\n\n.form-group label:not(.isuser) {\n  /* position: absolute;\n  top: -20px;\n  left: 0; */\n  color: #070707;\n  display: block;\n  width: 100%;\n}\n\n.form-group input:not([type=checkbox]),\n.form-group select {\n  padding-left: 5px;\n  width: 85%;\n}\n\n.form-inline {\n  width: 100%;\n  padding-bottom: 6px;\n}\n\n/* .form-group input:focus+label,\n.form-group select:focus+label,\n.form-group label.hasValue {\n    top: -20px;\n    left: 0;\n    color: #00c6c6;\n    font-weight: bold;\n    animation: shake 0.5s;\n} */\n\ni {\n  display: inline-block;\n  border: 1px solid #ccc;\n  width: 25px;\n  height: 25px;\n  line-height: 25px;\n  border-radius: 50%;\n  margin: 0;\n  text-align: center;\n  background: #fff;\n  color: #00c5c5;\n}\n\n.fa {\n  cursor: pointer;\n}\n\n.contactowner {\n  position: relative;\n}\n\n.contactowner > ul {\n  position: absolute;\n  top: 31px;\n  left: 0;\n  display: none;\n  box-shadow: 0px 1px 2px #333;\n  width: 163px;\n}\n\n.contactowner > ul:hover,\n.contactowner > input:focus ~ ul {\n  display: block !important;\n}\n\n.custom-file-input {\n  width: auto;\n}\n\n.reporttolist {\n  position: absolute;\n  top: 50px;\n  max-height: 250px;\n  overflow: auto;\n  z-index: 99;\n  border: 1px solid #ccc;\n  min-width: 100%;\n}\n\n.reporttolist ul {\n  margin: 0;\n  padding: 0 2px;\n}\n\n.reporttolist li {\n  white-space: nowrap;\n}\n\n.custom-file-label {\n  right: auto;\n  width: 250px;\n}\n\n.no-flex {\n  flex: none;\n}\n\n.box {\n  box-shadow: inset 0px 0px 7px 3px #ccc;\n  padding: 0.8em 0;\n}\n\n.edit h4 {\n  font-size: 1rem;\n}\n\n.card-header {\n  height: 2em;\n  background: #037777;\n  color: #fff;\n}\n\n.container-fluid {\n  padding: 10px;\n  background-color: #fff;\n  border-radius: 8px;\n  border-bottom: 1px solid #00c6c6;\n}\n\n@keyframes shake {\n  0% {\n    transform: translate(1px, 1px) rotate(0deg);\n  }\n  10% {\n    transform: translate(-1px, -2px) rotate(-1deg);\n  }\n  20% {\n    transform: translate(-3px, 0px) rotate(1deg);\n  }\n  30% {\n    transform: translate(3px, 2px) rotate(0deg);\n  }\n  40% {\n    transform: translate(1px, -1px) rotate(1deg);\n  }\n  50% {\n    transform: translate(-1px, 2px) rotate(-1deg);\n  }\n  60% {\n    transform: translate(-3px, 1px) rotate(0deg);\n  }\n  70% {\n    transform: translate(3px, 1px) rotate(-1deg);\n  }\n  80% {\n    transform: translate(-1px, -1px) rotate(1deg);\n  }\n  90% {\n    transform: translate(1px, 2px) rotate(0deg);\n  }\n  100% {\n    transform: translate(1px, -2px) rotate(-1deg);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/views/contacts/edit-contcat/edit-contcat.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/views/contacts/edit-contcat/edit-contcat.component.ts ***!
  \***********************************************************************/
/*! exports provided: EditContcatComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditContcatComponent", function() { return EditContcatComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _services_event_emitter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/event-emitter.service */ "./src/app/services/event-emitter.service.ts");
/* harmony import */ var _services_contacts_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/contacts.service */ "./src/app/services/contacts.service.ts");
/* harmony import */ var src_app_providers_fetchserverdata__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/providers/fetchserverdata */ "./src/app/providers/fetchserverdata.ts");
/* harmony import */ var _contacts_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../contacts.component */ "./src/app/views/contacts/contacts.component.ts");
...
let EditContcatComponent = class EditContcatComponent {
    constructor(contactsComponent, toastr, serviceCallProvider, utils, _formBuilder, contactService, emService) {
        this.contactsComponent = contactsComponent;
        this.toastr = toastr;
        this.serviceCallProvider = serviceCallProvider;
        this.utils = utils;
    ...
    set contact(input) {
        if (this.title == 'Edit Contact' && input) {
            this.editObject = Object.assign({}, input);
    ...
    get contactsList() {
        return this.editcontactForm.get('newContacts');
    }
    checkSameContact(a, b) {
        return !a || a.id !== b;
    }
...
EditContcatComponent.ctorParameters = () => [
    { type: _contacts_component__WEBPACK_IMPORTED_MODULE_6__["ContactsComponent"] },
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])('closeAddContact')
], EditContcatComponent.prototype, "closeAddContact", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('createType')
], EditContcatComponent.prototype, "createType", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], EditContcatComponent.prototype, "title", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])("contact")
], EditContcatComponent.prototype, "contact", null);
EditContcatComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit-contcat',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-contcat.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/contacts/edit-contcat/edit-contcat.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-contcat.component.scss */ "./src/app/views/contacts/edit-contcat/edit-contcat.component.scss")).default]
    })
...
/***/ "./src/app/views/contacts/filter-contacts.pipe.ts":
/*!********************************************************!*\
  !*** ./src/app/views/contacts/filter-contacts.pipe.ts ***!
  \********************************************************/
/*! exports provided: FilterContactsPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilterContactsPipe", function() { return FilterContactsPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let FilterContactsPipe = class FilterContactsPipe {
    transform(value, orderBy = "name", orderType, search) {
        if (!value || !value.length)
            return value;
        let order = orderBy.toLocaleLowerCase().replace(/ /g, '');
        if (search)
...
FilterContactsPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'filterContacts '
    })
], FilterContactsPipe);
...
/***/ "./src/app/views/contacts/text-search-filter.pipe.ts":
/*!***********************************************************!*\
  !*** ./src/app/views/contacts/text-search-filter.pipe.ts ***!
  \***********************************************************/
/*! exports provided: TextSearchFilterPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextSearchFilterPipe", function() { return TextSearchFilterPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let TextSearchFilterPipe = class TextSearchFilterPipe {
    transform(value, orderBy = "name", orderType, search) {
        if (!value || !value.length)
            return value;
        let order = orderBy.toLocaleLowerCase().replace(/ /g, '');
...
TextSearchFilterPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
